...
interface PhotoThumbnailProps {
  /** PhotoLog id - fetched via the authenticated /api/photo-log/file/[id] endpoint */
  photoId: string;
 ...
 * an object URL. Used anywhere a photo-log entry needs a visual thumbnail.
 */
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const response = await fetch(`/api/photo-log/file/${photoId}`, {
